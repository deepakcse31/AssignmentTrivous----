 ...
 * Use the {@link Hindustan#newInstance} factory method to
...
public class Hindustan extends Fragment {
     ...
     * @return A new instance of fragment Hindustan.
     */
    // TODO: Rename and change types and number of parameters
    public static Hindustan newInstance(String param1, String param2) {
        Hindustan fragment = new Hindustan();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_hindustan, container, false);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i=0;i<array1.length();i++)
                            {
                                ...
                                if (name1.equals("Hindustan Times"))
                                {
                                    News news=new News();
