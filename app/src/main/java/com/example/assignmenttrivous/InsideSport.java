 ...
 * Use the {@link InsideSport#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InsideSport extends Fragment {
     ...
     * @return A new instance of fragment InsideSport.
     */
    // TODO: Rename and change types and number of parameters
    public static InsideSport newInstance(String param1, String param2) {
        InsideSport fragment = new InsideSport();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_inside_sport, container, false);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i=0;i<array1.length();i++)
                            {
                                ...
                                if (name1.equals("The Indian Express"))
                                {
                                    News news=new News();
