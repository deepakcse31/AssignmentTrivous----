 ...
 * Use the {@link Livemint#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Livemint extends Fragment {
     ...
     * @return A new instance of fragment Livemint.
     */
    // TODO: Rename and change types and number of parameters
    public static Livemint newInstance(String param1, String param2) {
        Livemint fragment = new Livemint();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_livemint, container, false);
                        ...
                        try {
                            ...
                            for (int i=0;i<array1.length();i++)
                            {
                                ...
                                if (name1.equals("Livemint"))
                                {
                                    ...
                                    Toast.makeText(getActivity().getApplicationContext(),"No News",Toast.LENGTH_LONG).show();
                                }
                            }
